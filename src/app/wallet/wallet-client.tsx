    ...
    <MainLayout>
      <div className="max-w-5xl mx-auto animate-fade-in">
        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a] border border-white/10 p-8 shadow-2xl">
             ...
             <div className="space-y-4">
               ...
               <div className="grid grid-cols-4 gap-2">
                 {["100", "200", "500", "1000"].map((val) => (
                   <button key={val} onClick={() => setAmount(val)} className={`py-2 rounded-lg text-xs font-bold transition-all border ${amount === val ? 'bg-chido-cyan text-black border-chido-cyan' : 'bg-white/5 text-zinc-400 border-transparent'}`}>${val}</button>
                 ))}
               </div>

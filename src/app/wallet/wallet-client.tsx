...
import { CreditCard, ArrowUpRight, ShieldCheck, AlertCircle, Coins, Lock } from "lucide-react";
...
export default function WalletClient() {
  ...
  useEffect(() => {
    if (depositFlag === "ok") setMsg({ type: 'success', text: "¡Depósito exitoso! Tu saldo se actualizará en breve." });
    if (depositFlag === "cancel") setMsg({ type: 'error', text: "Depósito cancelado." });
        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8">
          ...
          <div className="rounded-3xl bg-zinc-900/50 border border-white/5 p-6 backdrop-blur-sm">
             <div className="flex items-center justify-between mb-6">
                <h2 className="font-bold text-lg text-white">Cargar Saldo</h2>

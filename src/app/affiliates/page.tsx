  ...
  return (
    <MainLayout>
      <div className="max-w-5xl mx-auto text-center py-12 animate-fade-in">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-chido-cyan/30 bg-chido-cyan/10 text-chido-cyan text-xs font-black tracking-widest uppercase mb-6">Socios Chido - Powered by Curvewind</div>
